...
Lab-editable AgentMux export for the proven `hauhau-agent` GGUF / llama.cpp serving preset.
...
- Mux: `hauhau-agent-gguf`
- Service: `main`
- Container: `agentmux-hauhau-agent-gguf-main`
- Host port: `8002`
- Container port: `5000`
- Runtime: `~/runs/agentmux/hauhau-agent-gguf/main -> /runs` (added by AgentMux)
...
- Preset name: `hauhau-agent`
- Backend: `llama.cpp` / GGUF
- Image: `localhost/llm-gguf:latest`
- Image info at export: `localhost/llm-gguf:latest 2bfecd790745 2 weeks ago`
...
- Served model name: `hauhau-agent`
- Export timestamp: `2026-07-06T16:20:48-06:00`
...
server:
  ...
  cache-type-v: q8_0
  kv-unified: true
  model: /models/active-gguf/hauhau-agent.gguf
  alias: hauhau-agent
sampling:
  temperature: 1.0
...
metadata:
  ...
  sampling_provenance:
    ...
    origin: /home/poop/models/hf/hub/models--HauhauCS--Qwen3.6-35B-A3B-Uncensored-HauhauCS-Aggressive/snapshots/f12a584fecbeb5f20001130d8ecd66c9327ae685/Qwen3.6-35B-A3B-Uncensored-HauhauCS-Aggressive-Q3_K_P.gguf
    extracted_keys:
...
--kv-unified
--model
/models/active-gguf/hauhau-agent.gguf
--alias
hauhau-agent
--temperature
1.0
